...
const url = 'http://api.tvmaze.com/search/shows?q=startgate';
...
export default class HomeScreen extends Component {
	 ...
	 onGoBack = (someDataFromChild) => {
			console.log('SomeChildData:', someDataFromChild)
	 };
			...
			const cards = data.map(item => (
				<ImageCard
					...
					onPress={() => navigation.navigate(STARGATE_DETAILS,
						({show: item.show, onGoBack: this.onGoBack}))}/>
			));
